...
/*
    Version:    1.0.3 | viveros
*/

var  CarouselOption = new Object;

CarouselOption.Thumbs = function(){
...
CarouselOption.Stage = function (){

    var TypeAnimate = "";
    if($(window).width() < 500){
        TypeAnimate = "uncover-fade";
    }else{
        TypeAnimate = "scroll";
    }
...
CarouselOption.OtherFunction = function (){

     $(".StageContainerThumbs").find("li").bind("click", function () {
        var b = $(this).data("statuslider");
        $(".StageContainterLarge").trigger("slideTo", ['li[data-statuslider="' + b + '"]']);
    });
    ...
    function a(i) {
        ...
        if (d < 500) {
            $(".StageContainerThumbs").trigger("configuration", ["items", 7]);
        ...
        var k = f / 1.33;
        var h = $(".StageContainterLarge li").parent("ul");
        ...
        CarouselOption.Thumbs();
        CarouselOption.Stage();
    }
    a();
